...
# REVISED DATE:
# PURPOSE: Function calculates_results_stats calculates the statistics
...
#          This function then puts the results statistics in a dictionary
#          (results_stats_dic) that's created and returned by this function.
#          This will allow the user of the program to determine the 'best'
#          model for classifying the images. The statistics that are calculated
#          will be counts and percentages.
#         This function inputs:
#            -The results dictionary as results_dic in the calculates_results_stats
